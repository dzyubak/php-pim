...
<td><?= mb_strlen($item->getNote(),"UTF-8") < 39 ? $item->getNote() : mb_substr(strip_tags($item->getNote()),0,39,"UTF-8").'...'; ?></td>
...
<center>
<?php
echo Paginator::paginatedLinks('review', $total, $offset, $perPage)
