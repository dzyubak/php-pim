...
<title>Sorting items by Date</title>
...
<h1>Sorting items by Date</h1>

<form name="sort" action="<?=BASE_URL?>sort_items_by_date_paginated" method="post">
...
<center>
<?php
echo Paginator::paginatedLinks('sort_items_by_date_paginated', $total, $offset, $perPage)
